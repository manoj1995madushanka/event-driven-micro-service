...
public class QueryController {
    ...
    public String queryByText(@Valid EQWCRequestModel requestModel, Model model) {
        Flux<EQWCResponseModel> responseModel = elasticQueryWebClient.getDataByText(requestModel);
