package com.event_driven_ms.kafka_producer.config;

import com.event_driven_ms.config.KafkaConfigData;
import com.event_driven_ms.config.KafkaProducerConfigData;
...
public class KafkaProducerConfig<K extends Serializable, V extends SpecificRecordBase> {
    ...
    /*
    kafka template is a thread safe template for executing high level producer operations
     */
    @Bean
