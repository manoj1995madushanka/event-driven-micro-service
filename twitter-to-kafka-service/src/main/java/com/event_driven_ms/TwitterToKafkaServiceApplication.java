package com.event_driven_ms;

import com.event_driven_ms.init.StreamInitializer;
...
public class TwitterToKafkaServiceApplication implements CommandLineRunner {
    ...
    public TwitterToKafkaServiceApplication(@Qualifier("mockKafkaStreamRunner") StreamRunner streamRunner, StreamInitializer streamInitializer) {
