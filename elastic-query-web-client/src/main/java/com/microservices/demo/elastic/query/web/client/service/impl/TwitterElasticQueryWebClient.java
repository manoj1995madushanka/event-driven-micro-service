...
public class TwitterElasticQueryWebClient implements ElasticQueryWebClient {
    ...
    /**
     * here we intregate our custom webClientBuilder (WebClientConfig class) using qualifier
     * */
    ...
    @Override
    public List<EQWCResponseModel> getDataByText(EQWCRequestModel requestModel) {
        LOG.info("Querying by text {}", requestModel.getText());
        return getWebClient(requestModel)
                .bodyToFlux(EQWCResponseModel.class)
                .collectList()
                .block();
    }

    private WebClient.ResponseSpec getWebClient(EQWCRequestModel requestModel) {
